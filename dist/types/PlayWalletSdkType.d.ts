...
import { ResponseType, JwtDataType, PreparedDataType, ResponseUnsignedType } from './PlayWalletApiType';
declare const BLOCK_TAGS_CONST: Readonly<{
    EARLIEST: "earliest";
    FINALIZED: "finalized";
    LATEST: "latest";
    PENDING: "pending";
...
export type { PlayWalletSdkOptionsType, UserInfoType, QRPrepareParamType, QRTokenParamType, ExtraApprovedType, PlayUnsignedTxType, UnsignedTxType, WemixTxRequestType, WemixTxObjectType, BalanceType, AccessListType, TxCallType, NumbersType, BlockTagType, BlockNumberOrTagType, AddressType, MessageType, ChainIdType, EIP712TypedDataType, AddChainParamsType };
