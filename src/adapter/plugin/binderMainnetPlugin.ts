...
const REQUEST_ACTION_TYPES_BINDER_MAINNET = Object.freeze({
...
class BinderMainnetPlugin {
  constructor() {}

  async request(params: any) {
    if (Object.values(REQUEST_ACTION_TYPES_BINDER_MAINNET).includes(params?.method)) {
      return requestBinderMainnetApi(params?.params);
    }
